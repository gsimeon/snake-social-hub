      ...
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        {isAuthenticated && (
          <div className="w-full max-w-sm text-center">
            <p className="text-xs text-muted-foreground font-arcade mb-2">Want to change your look?</p>
            <a href="/profile" className="text-xs font-arcade text-primary hover:underline">VISIT PROFILE</a>
          </div>
        )}
      </div>
    </div>
