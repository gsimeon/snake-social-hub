...
export const GameBoard = ({ snake, food, mode, isSpectating = false, playerColor = 'primary' }: GameBoardProps) => {
  const renderCell = (x: number, y: number) => {
    ...
    const skinColor = playerColor || 'green';
    const bgClass = {
      'green': 'bg-green-500',
      'blue': 'bg-blue-500',
      'red': 'bg-red-500',
    ...
    return (
      <div
        ...
        className={cn(
          ...
          isSnakeHead && `${bgClass} rounded-sm animate-snake-move`,
          isSnakeBody && `${bgClass} opacity-80 rounded-sm`,
        ...
        style={{
          boxShadow: isSnakeHead
            ...
            : isFood
              ...
              : undefined,
          color: isSnakeHead ? 'inherit' : undefined
        }}
      />
    );
  };
